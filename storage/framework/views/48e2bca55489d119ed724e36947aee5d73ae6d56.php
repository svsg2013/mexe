    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <?php echo Form::open(['route' => ['batu.update',$dataPage->id],'class'=>'form-horizontal','method'=>'put','role'=>'form','enctype'=>'multipart/form-data']); ?>
                    ...
                    <div class="col-md-12">
                        <div class="p-20">
                            ...
                            <div class="form-group">
                                <?php echo Form::label('Image','Background',['class'=>'col-md-2 control-label']); ?>
