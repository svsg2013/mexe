    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <?php echo Form::open(['route' => ['furniture.update',$getPosts->id],'class'=>'form-horizontal','method'=>'put','role'=>'form','enctype'=>'multipart/form-data']); ?>
                    ...
                    <div class="col-md-8">
                        <div class="p-20">
                            ...
                            <div class="form-group">
                                <?php echo Form::label('Thumbnail','Thumbnail (368 x 246)',['class'=>'col-md-2 control-label']); ?>
