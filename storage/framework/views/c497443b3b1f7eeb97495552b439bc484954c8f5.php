    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <?php echo Form::open(['route'=>'tuyendung.store','class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data']); ?>
                    ...
                    <div class="col-md-12">
                        <div class="p-20">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <?php echo Form::textarea('txtContent',old('txtName'),['class'=>'form-control','id'=>'editor1']); ?>
