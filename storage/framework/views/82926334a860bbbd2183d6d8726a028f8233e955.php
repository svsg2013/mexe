        ...
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <table id="datatable-fixed-header" class="table table-striped table-bordered">
                    ...
                    <tbody>
                    <?php $__currentLoopData = $cateProds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($cate->name); ?></td>
                            <td><img src="<?php echo e(asset('upload/thumbnail/'.$cate->metaName)); ?>" width="300"/></td>
                            <td>
                                <?php if($cate->lvl==0): ?>
                                    <?php echo '<span style="color: red;font-weight: 600;">Thư mục cha</span>'; ?>
                                <?php else: ?>
                                    <?php 
                            ...
                            <td style="text-align: center"><?php echo e($cate->weight); ?></td>
                            <td>
                                <a href="<?php echo e(route('cateprod.edit',$cate->cateParen_id)); ?>">
                                    <button type="button" class="btn btn-icon waves-effect waves-light btn-warning"><i
                                                class="fa fa-wrench"></i></button>
                                </a>
                                <a href="<?php echo e(route('cateprod.delete',$cate->cateParen_id)); ?>">
