                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="p-20">
                            ...
                            <div class="form-group">
                                <?php echo Form::label('Thumbnail','Thumbnail (563 x 549)',['class'=>'col-md-2 control-label']); ?>
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            ...
                            <!-- prices -->
                            <div class="form-group">
                                <?php echo Form::label('prices','Giá sản phẩm ',['class'=>'col-md-3 control-label']); ?>

                                <div class="col-md-12">
                                    <?php echo Form::text('txtPrices',old('txtPrices',isset($getPosts->prices)?$getPosts->prices:null),['placeholder'=>'Nhập giá sản phẩm hoặc để trống','class'=>'form-control']); ?>
