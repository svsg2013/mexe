        ...
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <table id="datatable-fixed-header" class="table table-striped table-bordered">
                    ...
                    <tbody>
                    <?php $__currentLoopData = $Faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $get): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($get->name); ?></td>
                        <td><?php echo e($get->phone); ?></td>
                        <td><?php echo e($get->email); ?></td>
                        <td><?php echo e($get->content); ?></td>
                        <td>
                            
                            <a href="<?php echo e(route('comment.delete',$get->id)); ?>"><button type="button" class="btn btn-icon waves-effect waves-light btn-danger"> <i class="fa fa-remove"></i> </button></a>
                        </td>
                    </tr>
