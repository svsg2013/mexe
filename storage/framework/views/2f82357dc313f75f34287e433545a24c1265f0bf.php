        ...
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-20">
                            <?php echo Form::open(['route' => 'partner.store','class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data']); ?>

                            <div class="form-group">
                                <?php echo Form::label('title','Tên Partner*',['class'=>'col-md-2 control-label']); ?>

                                <div class="col-md-10">
                                    <?php echo Form::text('txtName',old('txtName'),['placeholder'=>'Nhập tên Partner','class'=>'form-control']); ?>
