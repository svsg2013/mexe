        ...
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-20">
                            <?php echo Form::open(['route' => ['slider.update',$list->id],'method'=>'put','class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data']); ?>

                            <div class="form-group">
                                <?php echo Form::label('title','Tên Slider*',['class'=>'col-md-2 control-label']); ?>

                                <div class="col-md-10">
                                    <?php echo Form::text('txtName',old('txtName',isset($list->name)?$list->name:null),['placeholder'=>'Nhập tên SLider','class'=>'form-control']); ?>
                            ...
                            <div class="form-group">
                                <?php echo Form::label('hinh-slider','Image (1170 x 450)',['class'=>'col-md-2 control-label']); ?>
                            ...
                            <div class="form-group">
                                <?php echo Form::label('hinh-slider','Hình Slider hiện tại',['class'=>'col-md-2 control-label']); ?>

                                <div class="col-md-10">
                                    <img src="<?php echo e(asset('upload/slider/'.$list->images)); ?>" style="width: 300px" />
                                </div>
                            </div>
                            <div class="form-group">
