...
<head>
    ...
    <!-- DataTables -->
    <link href="<?php echo e(asset('backend/plugins/datatables/buttons.bootstrap.min.css')); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(asset('backend/plugins/datatables/fixedHeader.bootstrap.min.css')); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(asset('backend/plugins/datatables/responsive.bootstrap.min.css')); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(asset('backend/plugins/datatables/scroller.bootstrap.min.css')); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(asset('backend/plugins/datatables/dataTables.colVis.css')); ?>" rel="stylesheet" type="text/css')}}"/>
    <link href="<?php echo e(asset('backend/plugins/datatables/dataTables.bootstrap.min.css')); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo e(asset('backend/plugins/datatables/fixedColumns.dataTables.min.css')); ?>" rel="stylesheet" type="text/css"/>

    <!-- Jquery filer css -->
    <link href="<?php echo e(asset('backend/plugins/jquery.filer/css/jquery.filer.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('backend/plugins/jquery.filer/css/themes/jquery.filer-dragdropbox-theme.css')); ?>" rel="stylesheet" />

    <!-- Bootstrap fileupload css -->
    <link href="<?php echo e(asset('backend/plugins/bootstrap-fileupload/bootstrap-fileupload.css')); ?>" rel="stylesheet" />

    <script src="<?php echo e(asset('backend/js/ckeditor/ckeditor.js')); ?>"></script>
    <script src="<?php echo e(asset('backend/js/ckfinder/ckfinder.js')); ?>"></script>
    <script type="text/javascript">
        var baseURL= "<?php echo e(url('/')); ?>";
    </script>
    <script src="<?php echo e(asset('backend/js/func_ckfinder.js')); ?>"></script>
    <!-- App favicon -->
    <link rel="shortcut icon" href="<?php echo e(asset('backend/images/favicon.ico')); ?>">

    <!-- C3 charts css -->
    <link href="<?php echo e(asset('backend/plugins/c3/c3.min.css')); ?>" rel="stylesheet" type="text/css"  />

    <!-- App css -->
    <link href="<?php echo e(asset('backend/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('backend/css/core.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('backend/css/components.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('backend/css/icons.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('backend/css/pages.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('backend/css/menu.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('backend/css/responsive.css')); ?>" rel="stylesheet" type="text/css" />

    <script src="<?php echo e(asset('backend/js/modernizr.min.js')); ?>"></script>
    <!--mystyle-->
    <link href="<?php echo e(asset('backend/css/mystyle.css')); ?>" rel="stylesheet" type="text/css"/>
...
<div id="wrapper">
    ...
    <div class="topbar">
        ...
        <div class="topbar-left">
            ...
            <a href="index.html" class="logo">
                                <span>
                                    <img src="<?php echo e(asset('backend/images/logo.png')); ?>" alt="" height="25">
                                </span>
                <i>
                    <img src="<?php echo e(asset('backend/images/logo_sm.png')); ?>" alt="" height="28">
                </i>
            </a>
        </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown user-box">
                        <a href="" class="dropdown-toggle waves-effect user-link" data-toggle="dropdown" aria-expanded="true">
                            <img src="<?php echo e(asset('backend/images/users/avatar-1.jpg')); ?>" alt="user-img" class="img-circle user-img">
                        </a>
    ...
    <!-- ========== Left Sidebar Start ========== -->
<?php echo $__env->make('admin.partial.navleft', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<!-- Left Sidebar End -->
    <!-- ============================================================== -->
...
<!-- Toastr js -->
<script src="<?php echo e(asset('backend/plugins/jquery-toastr/jquery.toast.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('backend/pages/jquery.toastr.js')); ?>" type="text/javascript"></script>

<!-- Counter js  -->
<script src="<?php echo e(asset('backend/plugins/waypoints/jquery.waypoints.min.js')); ?>"></script>
<script src="<?php echo e(asset('backend/plugins/counterup/jquery.counterup.min.js')); ?>"></script>

<!--C3 Chart-->
<script type="text/javascript" src="<?php echo e(asset('backend/plugins/d3/d3.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('backend/plugins/c3/c3.min.js')); ?>"></script>

<!--Echart Chart-->
<script src="<?php echo e(asset('backend/plugins/echart/echarts-all.js')); ?>"></script>

<!-- Dashboard init -->
<script src="<?php echo e(asset('backend/pages/jquery.dashboard.js')); ?>"></script>

<!-- App js -->
<script src="<?php echo e(asset('backend/js/jquery.core.js')); ?>"></script>
<script src="<?php echo e(asset('backend/js/jquery.app.js')); ?>"></script>
<!--hixxx myscript-->
<script src="<?php echo e(asset('backend/js/myScript.js')); ?>"></script>
