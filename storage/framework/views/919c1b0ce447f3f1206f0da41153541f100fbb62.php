    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <?php echo Form::open(['route' => 'prods.store','class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data']); ?>
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-4">
                            <?php echo Form::label('SP Nổi bật'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <?php echo Form::text('txtPrices',old('txtPrices'),['placeholder'=>'Nhập giá sản phẩm hoặc để trống','class'=>'form-control']); ?>
