        ...
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-20">
                            <?php echo Form::open(['route' => ['cateprod.update',$catePaId->cateParen_id],'method'=>'put','class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data']); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" name="slMenu">
                                        ...
                                        <?php echo e(getMenu($datas,0,$char='|--',$catePaId->lvl)); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <?php echo Form::text('txtMeta',old('txtName',isset($catePaId)?$catePaId->metaName:null),['placeholder'=>'To type here if any','class'=>'form-control']); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <?php echo Form::textarea('txtDescription',old('txtName',isset($catePaId)?$catePaId->description:null),['placeholder'=>'To type here if any','class'=>'form-control','rows'=>5]); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <img src="<?php echo e(asset('upload/thumbnail/'.$catePaId->metaName)); ?>" class="img-rounded" width="300">
                                </div>
                            </div>
                            <div class="form-group">
