    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <?php echo Form::open(['route' => ['prods.update',$getPosts->id],'class'=>'form-horizontal','method'=>'put','role'=>'form','enctype'=>'multipart/form-data']); ?>
                    ...
                    <div class="col-md-8">
                        <div class="p-20">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <?php echo Form::text('txtName',old('txtName',isset($getPosts->title)?$getPosts->title:null),['placeholder'=>'To type here','class'=>'form-control']); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <?php echo Form::text('txtMetatitle',old('txtName',isset($getPosts->metaTitle)?$getPosts->metaTitle:null),['placeholder'=>'To type here','class'=>'form-control']); ?>
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="cusWeight">
                                    <?php echo Form::label('Prices'); ?>

                                    <?php echo Form::text('txtPrices',old('txtPrices',isset($getPosts->prices)?$getPosts->prices:null)); ?>
                            ...
                            <div class="col-md-12">
                                <div class="cusWeight">
                                    ...
                                    <?php echo Form::text('txtDiscount',old('txtDiscount',isset($getPosts->discount)?$getPosts->discount:null)); ?>
                            ...
                            <?php $__currentLoopData = $getImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(isset($img)): ?>
                                    <div class="col-md-12 customText">
                                        <div class="thumbnail" style="background-image: url(<?php echo e(asset('upload/imgProds/'.$img['images'])); ?>);">
                                            <img src="<?php echo e(asset('upload/imgProds/'.$img['images'])); ?>" alt="">
                                        </div>
                                        <button type="button" class="removeQuatationBtn btn btn-custom customButton" data-value="<?php echo e($img['id']); ?>"><i class="fa fa-close"></i></button>
                                        <?php echo Form::file('editImages['.$img['id'].']',['class'=>'form-control formCustom']); ?>
