    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <?php echo Form::open(['route' => 'fengshui.store','class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data']); ?>
                    ...
                    <div class="col-md-8">
                        <div class="p-20">
                            ...
                            <div class="form-group">
                                <?php echo Form::label('title','Tiêu đề SEO',['class'=>'col-md-2 control-label']); ?>
                            ...
                            <div class="form-group">
                                <?php echo Form::label('Summary','Tóm tắt SEO',['class'=>'col-md-2 control-label']); ?>
                            ...
                            <div class="form-group">
                                <?php echo Form::label('Thumbnail','Hình (500 x 500)',['class'=>'col-md-2 control-label']); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group cusSelect" style="margin-top: 5px;">
                                    ...
                                    <select multiple class="form-control" name="slPost[]">
                                        <?php $__currentLoopData = $getPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getPost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value=<?php echo e($getPost->id); ?>><?php echo e($getPost->title); ?></option>
                                ...
                                <div class="form-group cusSelect" style="margin-top: 5px;">
                                    ...
                                    <select multiple class="form-control" name="slProd[]">
                                        <?php $__currentLoopData = $getTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value=<?php echo e($getProduct->id); ?>><?php echo e($getProduct->title); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
