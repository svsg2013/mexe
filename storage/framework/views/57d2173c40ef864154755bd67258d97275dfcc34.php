...
<div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <?php echo Form::text('txtPhone',old('txtPhone'),['placeholder'=>'0933.127.460','class'=>'form-control']); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <?php echo Form::email('txtEmail',old('txtEmail'),['placeholder'=>'shopfoyo@gmail.com','class'=>'form-control']); ?>
