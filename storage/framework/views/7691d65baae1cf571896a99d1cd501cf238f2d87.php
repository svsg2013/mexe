                    ...
                    <div class="col-md-12">
                        <div class="p-20">
                            ...
                            <div class="form-group">
                                <?php echo Form::label('title','Tên*',['class'=>'col-md-2 control-label']); ?>
                            ...
                            <div class="form-group">
                                <?php echo Form::label('hinh-slider','Image',['class'=>'col-md-2 control-label']); ?>
                            ...
                            <div class="form-group">
                                <?php echo Form::label('Ẩn hiện','Ẩn / Hiện',['class'=>'col-md-2 control-label']); ?>
