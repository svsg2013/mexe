                    ...
                    <div class="col-md-12">
                        <div class="p-20">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <?php echo Form::text('txtMeta',old('txtMeta',isset($catePaId)?$catePaId->metaName:null),['placeholder'=>'To type here if any','class'=>'form-control']); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <?php echo Form::textarea('txtDescription',old('txtDescription',isset($catePaId)?$catePaId->description:null),['placeholder'=>'To type here if any','class'=>'form-control','rows'=>5]); ?>
