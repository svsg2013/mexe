                    ...
                    <?php $__currentLoopData = $cates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td >
                                ...
                                <?php else: ?>
                                    <?php
                                    $catePa= DB::table('cate_furs')
                                        ->leftjoin('child_furs','cate_furs.id','=','child_furs.cateParen_id')
                                        ->select('name')->where('cate_furs.id','=',$cate->lvl)
                                        ->get()->first();
                            ...
                            <td>
                                <a href="<?php echo e(route('catefurniture.edit',$cate->cateParen_id)); ?>"><button type="button" class="btn btn-icon waves-effect waves-light btn-warning">  <i class="fa fa-wrench"></i> </button></a>
