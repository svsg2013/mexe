        ...
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-20">
                            <?php echo Form::open(['route' => ['catefurniture.update',$catePaId->cateParen_id],'method'=>'put','class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data']); ?>
                            ...
                            <div class="form-group">
                                <?php echo Form::label('Image','Image (127 x 97)',['class'=>'col-md-2 control-label']); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <?php echo Form::file('fileMenu',['class'=>'form-control']); ?>

                                </div>
                            </div>
                            <div class="form-group">
                                <?php echo Form::label('Image','Image (1360 x 390)',['class'=>'col-md-2 control-label']); ?>

                                <div class="col-md-10">
                                    <img src="<?php echo e(asset('upload/thumbnail/'.$catePaId->description)); ?>" class="img-rounded" width="300">
                                </div>
                            </div>
                            <div class="form-group">
                                <?php echo Form::label('Thumbnail','Hình Banner',['class'=>'col-md-2 control-label']); ?>
