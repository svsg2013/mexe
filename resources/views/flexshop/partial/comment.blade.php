...
<div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            {!! Form::text('txtPhone',old('txtPhone'),['placeholder'=>'0933.127.460','class'=>'form-control']) !!}
        </div>
    </div>
    <div class="form-group">
        {!! Form::label('title','E-mail',['class'=>'col-md-2 control-label']) !!}
        <div class="col-md-10">
            {!! Form::email('txtEmail',old('txtEmail'),['placeholder'=>'shopfoyo@gmail.com','class'=>'form-control']) !!}
        </div>
    </div>
    <div class="form-group">
