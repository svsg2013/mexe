                    ...
                    <div class="col-md-12">
                        <div class="p-20">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    {!! Form::text('txtMeta',old('txtMeta',isset($catePaId)?$catePaId->metaName:null),['placeholder'=>'To type here if any','class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('Meta Description','Meta Description',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
                                    {!! Form::textarea('txtDescription',old('txtDescription',isset($catePaId)?$catePaId->description:null),['placeholder'=>'To type here if any','class'=>'form-control','rows'=>5]) !!}
                                </div>
                            </div>
                            <div class="form-group">
