                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="p-20">
                            ...
                            <div class="form-group">
                                {!! Form::label('title','Tiêu đề cho SEO',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
                            ...
                            <div class="form-group">
                                {!! Form::label('Summary','Tóm tắt cho SEO',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
                            ...
                            <div class="form-group">
                                {!! Form::label('Thumbnail','Hình đại diện (368 x 246)',['class'=>'col-md-2 control-label']) !!}
                                <div class="col-md-10">
