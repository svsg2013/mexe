                    ...
                    <div class="col-md-8">
                        <div class="p-20">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <img src="{{asset('upload/thumbnail/'.$getPosts->images)}}" class="img-rounded"
                                         alt="{{$getPosts->title}}" width="300">
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <!-- Slide THREE -->
                                <div class="slideThree">
                                    <input type="checkbox" {{$getPosts->hot == 1?'checked':null}} value="1"
                            ...
                            <!-- Slide THREE -->
                                <div class="slideThree1">
                                    <input type="checkbox" {{$getPosts->feature == 1?'checked':null}} value="1"
                            ...
                            <!-- Slide THREE -->
                                <div class="slideThree2">
                                    <input type="checkbox" {{$getPosts->active == 1?'checked':null}} value="1"
                            ...
                            <!-- prices -->
                            <div class="form-group">
                                {!! Form::label('prices','Giá sản phẩm ',['class'=>'col-md-3 control-label']) !!}
                                <div class="col-md-12">
                                    {!! Form::text('txtPrices',old('txtPrices',isset($getPosts->prices)?$getPosts->prices:null),['placeholder'=>'Nhập giá sản phẩm hoặc để trống','class'=>'form-control']) !!}
                                </div>
                            </div>
